...
function header_events() {
  ...
  function scroll_event() {
    if (
      document.querySelector("#header_div").getBoundingClientRect().bottom <
      ...
      document.querySelector("#header_div").style.boxShadow =
        "0px 5px 30px rgba(0, 0, 0, 0.7)";
